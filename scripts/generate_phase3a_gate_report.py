...
from geoclt.benchmark import evaluate_falsifiers
...
from geoclt.receipts import compute_receipt_hash, emit_decision_receipt
...
def main() -> int:
    ...
    report: dict[str, Any] = {
        ...
        "artifact_bundle_linkage_valid": receipt_one["immutable_bundle_hash"] == bundle_hash,
